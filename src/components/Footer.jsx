            ...
            <div className="flex flex-wrap justify-center md:justify-start gap-6 text-sm text-gray-400 mb-6 md:mb-0">
              ...
              <a className="group relative hover:text-white transition-colors duration-300 cursor-pointer">
                ...
                <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-3 w-72 bg-gray-800 border border-gray-700 text-gray-200 text-xs rounded-lg p-3 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none z-50 shadow-xl">
                  ...
                  <p>By using JobPortal you agree to our terms. You are responsible for maintaining the confidentiality of your account. We reserve the right to terminate accounts that violate our community guidelines.</p>
              ...
              <a className="group relative hover:text-white transition-colors duration-300 cursor-pointer">
                ...
                <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-3 w-72 bg-gray-800 border border-gray-700 text-gray-200 text-xs rounded-lg p-3 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none z-50 shadow-xl">
                  ...
                  <p>We use cookies to enhance your browsing experience, analyze site traffic, and personalize content. By continuing to use our site, you consent to our use of cookies. You can manage your preferences in your browser settings.</p>
                  <div className="absolute top-full left-1/2 -translate-x-1/2 border-4 border-transparent border-t-gray-800"></div>
                </div>
              </a>
              <Link
              ...
              >
                ...
                <div className="absolute inset-0 bg-gradient-to-r from-primary-600/20 to-purple-600/20 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300 -inset-2"></div>
                <div className="absolute bottom-full right-0 mb-3 w-72 bg-gray-800 border border-gray-700 text-gray-200 text-xs rounded-lg p-3 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none z-50 shadow-xl">
                  <p className="font-semibold text-white mb-1">Contact Us</p>
                  <p>Have a question or experiencing an issue? Send a message to our admin team and we'll get back to you as soon as possible.</p>
